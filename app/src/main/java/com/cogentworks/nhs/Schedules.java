...
public class Schedules {
    ...
    static
    {
        ...
        ADVISEMENT.add(new Pair<>("Period 1/2", 800));
        ADVISEMENT.add(new Pair<>("Break", 930));
        ADVISEMENT.add(new Pair<>("Advisement", 945));
        ADVISEMENT.add(new Pair<>("Period 3/4", 1005));
        ADVISEMENT.add(new Pair<>("Lunch", 1135));
        ADVISEMENT.add(new Pair<>("Period 5/6", 1215));
        ADVISEMENT.add(new Pair<>("Break", 145));
        ADVISEMENT.add(new Pair<>("7/8", 1400));
    }
    ...
    static
    {
        ...
        TUTORIAL.add(new Pair<>("Period 1/2", 800));
        TUTORIAL.add(new Pair<>("Break", 925));
        TUTORIAL.add(new Pair<>("Advisement/Tutorial", 940));
        TUTORIAL.add(new Pair<>("Period 3/4", 1025));
        TUTORIAL.add(new Pair<>("Lunch", 1150));
        TUTORIAL.add(new Pair<>("Period 5/6", 1230));
        TUTORIAL.add(new Pair<>("Break", 1355));
        TUTORIAL.add(new Pair<>("7/8", 1405));
    }
    ...
    static
    {
        ...
        COLLABORATION.add(new Pair<>("Period 1/2", 900));
        COLLABORATION.add(new Pair<>("Break", 1020));
        COLLABORATION.add(new Pair<>("Period 3/4", 1035));
        COLLABORATION.add(new Pair<>("Lunch", 1155));
        COLLABORATION.add(new Pair<>("Period 5/6", 1235));
        COLLABORATION.add(new Pair<>("Break", 1355));
        COLLABORATION.add(new Pair<>("7/8", 1410));
    }
}
